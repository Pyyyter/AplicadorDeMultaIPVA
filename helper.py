...
def _display_detected_frames(conf, model, st_frame, image, manager, is_display_tracking=None, tracker=None):
    """
...
def play_webcam(conf, model, manager):
    """
    Plays a webcam stream. Detects Objects in real-time using the YOLOv8 object detection model.
...
def play_stored_video(conf, model, manager):
    """
